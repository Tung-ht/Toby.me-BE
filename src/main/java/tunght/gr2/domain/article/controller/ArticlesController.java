package tunght.gr2.domain.article.controller;
...
import tunght.gr2.domain.article.servie.ArticleService;
import tunght.gr2.domain.article.servie.CommentService;
